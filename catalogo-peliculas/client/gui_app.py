...
class Frame(tk.Frame):
    ...
    def campos_pelicula(self):
        ...
        self.boton_guardar.config(width=20, font=('Arial', 12,"bold"), fg= "#DAD5D6", bg='#1658A2',cursor='hand2', activebackground="#35BD6F")
    ...
    def tabla_peliculas(self):
        ...
        orient = 'vertica', command= self.tabla.yview)
    ...
    def editar_datos(self):
        try:
            ...
            mensaje = 'No se ha seleccionado ningunregistro'
    ...
    def eliminar_datos(self):
        try:
            ...
            mensaje = 'No se ha seleccionado algun registro'
            messagebox.showerror(titulo, mensaje)